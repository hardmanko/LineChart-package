...
```{r}
lineChart(weight ~ Time * Diet, ChickWeight, legendPosition="topleft", errBarType="CI95", title="Chick weight as a function of time and diet", xlab="Day", ylab="Chick weight")
```
